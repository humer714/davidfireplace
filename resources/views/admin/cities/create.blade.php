                                ...
                                <div class="form-group">
                                    ...
                                    <div id="dynamic-url-container">
                                        ...
                                        <div class="col-lg-12 input-group mb-2">
                                            <input type="text"
                                                class="form-control form-control-lg @if ($errors->has('dynamic_url')) is-invalid @endif"
                                                required name="dynamic_url[]" placeholder="Enter dynamic URL"
                                                value="{{ old('dynamic_url') }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            container.addEventListener('click', function(event) {
                if (event.target && event.target.classList.contains('add-url-btn')) {
                    ...
                    <input type="text" class="form-control form-control-lg" required name="dynamic_url[]" placeholder="Enter dynamic URL">
