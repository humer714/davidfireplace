...
@section('content')
    ...
    <div class="pricing-area style-1 background-gray" style="padding-top: 25px !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="price-card">
                        <div class="list-wrapper">
                            ...
                            <div class="list">
                                @if(isset($detail_data->dynamic_url))
                                    @foreach(json_decode($detail_data->dynamic_url, true) as $url)
                ...
                <div class="col-lg-6">
                    <div class="price-card">
                        <p>
                            ...
                            We provide professional garage door installation services, ensuring that your new door is both
                            functional and aesthetically pleasing.
                            Garage Door Track Repair
                            Our track repair service addresses misalignments and damages, ensuring smooth and safe operation
                            of your garage door.
